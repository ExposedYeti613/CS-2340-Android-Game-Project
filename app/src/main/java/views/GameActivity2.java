...
public class GameActivity2 extends AppCompatActivity implements Movable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exitSprite = findViewById(R.id.exit2);

        speedBuff = findViewById(R.id.speedBuff2);

        attackBuff = findViewById(R.id.attackBuff2);

        heal = findViewById(R.id.heal2);
...
//animate the player
    ...
    private void launchEndScreenActivity(boolean playerWon) {
        Intent nextScreen3 = new Intent(GameActivity2.this, EndScreenActivity.class);
    ...
    private void launchGameActivity3() {
        Intent nextScreen2 = new Intent(GameActivity2.this,
                GameActivity3.class);
