...
public class GameActivity3 extends AppCompatActivity implements Movable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exitSprite = findViewById(R.id.exit3);

        speedBuff = findViewById(R.id.speedBuff3);

        attackBuff = findViewById(R.id.attackBuff3);

        heal = findViewById(R.id.heal3);
    ...
    public void launchEndScreenActivity(boolean playerWon) {
        Intent nextScreen3 = new Intent(GameActivity3.this, EndScreenActivity.class);
    ...
    private void launchEndScreenActivity() {
        Intent nextScreen3 = new Intent(GameActivity3.this,
                EndScreenActivity.class);
        handler.removeCallbacks(runnable);

        // Start EndScreenActivity
        startActivity(nextScreen3);
    }
    private void attack() {
        for (Enemy enemy : enemyMap.keySet()) {
